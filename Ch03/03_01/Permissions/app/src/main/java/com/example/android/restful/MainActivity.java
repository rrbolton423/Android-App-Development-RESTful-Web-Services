...
public class MainActivity extends AppCompatActivity {
    ...
    // Boolean value to keep track of the state of the network connectivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // As the Activity starts up, I'll be checking for NetworkConnectivity,
        // but I want to save that information so that it's always available
        // as long as the Activity is live.
