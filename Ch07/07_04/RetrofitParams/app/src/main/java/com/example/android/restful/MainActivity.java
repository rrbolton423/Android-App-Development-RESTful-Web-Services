...
//      Code to manage sliding navigation drawer
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Get the category that was selected from the DrawerLayout
                String category = mCategories[position];

                // Notify the user via Toast message
                ...
                // Pass the category selected from the DrawerLayout into the requestData() method
...
//      end of navigation drawer
    ...
    private void requestData() {
        ...
        // Get an instance of a Call object to a specific feed
        Call<DataItem[]> call = webService.dataItems();

        // Pass the Call object to execute it asynchronously
        sendRequest(call);
    }
    ...
    private void requestData(String category) {
        ...
        // Take the argument named category, and pass it to the dataItems() method.
        // Now I'm using the version of the dataItems method that receives the value
        // and passes it to the web service.
    ...
    private void sendRequest(Call<DataItem[]> call) {
        ...
        call.enqueue(new Callback<DataItem[]>() {
            ...
            public void onResponse(Call<DataItem[]> call, Response<DataItem[]> response) {
                ...
                // Turn the Array of DataItems into a list
                mItemList = Arrays.asList(dataItems);
