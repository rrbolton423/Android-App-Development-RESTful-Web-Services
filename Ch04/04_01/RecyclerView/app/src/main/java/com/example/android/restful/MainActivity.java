...
//    DataSource mDataSource;
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // Turn the array of DataItems back into an ArrayList
            // I'm taking a raw array and wrapping it in a complex list of objects
            mItemList = Arrays.asList(dataItems);

            // Instantiate the ItemAdapter
            // I'm displaying the data using a RecyclerView. With RecyclerView's, you always
            // use an adapter.
            // By calling displayDataItems(), whenever the data comes back from the service, I'm
...
//        displayDataItems(null);
        ...
        // If the network is okay, make the request to the web service
        if (networkOk) {
            ...
            // If I don't have network connectivity, display a Toast message
...
//        mItemList = mDataSource.getAllItems(category);
        ...
        // I only want to execute this code if I have valid data
        if (mItemList != null) {
